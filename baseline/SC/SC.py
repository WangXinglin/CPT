...
"""
vLLM offline sampling only (NO evaluation).
...
def main():
    parser = argparse.ArgumentParser(description="vLLM Sampling ONLY (IMO-AnswerBench)")
    ...
    parser.add_argument("--batch-size", "-b", type=int, default=8, help="Questions per chunk (NOT prompts)")
