...
def make_sampling_params(SamplingParams, config):
    kwargs = {
...
class DirectVLLMInferPipeline:
    ...
    def infer(self, prompts, config, micro_batch_size=None, return_details=False):
        ...
        sampling_params = make_sampling_params(self.SamplingParams, config)
...
def main(
    ...
    config = GenerateConfig(
        stop=["<summarize>"] if is_leap_t_model else None,
