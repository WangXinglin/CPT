...
class RayInferPipeline:
    def __init__(self, tokenizer, model_path, num_gpus, gpu_memory_utilization, tensor_parallel_size):
        # （ sys.path），：
        if socket.gethostname() == 'your-hostname':
            sys.path = ['', '/path/to/python/env/lib/python311.zip',
                        '/path/to/python/env/lib/python3.11',
                        '/path/to/python/env/lib/python3.11/lib-dynload',
                        '/path/to/python/env/lib/python3.11/site-packages',
                        '/path/to/project/py_src',
                        '/path/to/dependency/py_src']
            print(f'{sys.path=}')
